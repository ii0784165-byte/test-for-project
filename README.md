# 🛡️ OSINT Threat Intelligence Aggregation Platform

<div align="center">

![Python](https://img.shields.io/badge/Python-3.10+-3776AB?style=for-the-badge&logo=python&logoColor=white)
![OpenCTI](https://img.shields.io/badge/OpenCTI-Platform-FF5733?style=for-the-badge&logo=data:image/png;base64,&logoColor=white)
...
git clone https://github.com/<your-username>/osint-cti-platform.git
cd osint-cti-platform
...
Create a `.env` or `config/config.yaml` file with your API credentials:
...
> ⚠️ Never commit real API keys. Add `config.yaml` and `.env` to `.gitignore`.
...
```bash
0 * * * * /path/to/venv/bin/python3 /path/to/osint-cti-platform/main.py --run-pipeline >> /path/to/logs/cron.log 2>&1
```
